...
export const login = async (url: any, dados: any, setDados: any) => {
    ...
    setDados(resposta.data); // dentro da funcao setdado preciso dos valores da constante resposta que vai conter todos os dados da resposta da api - token/nomedeusuario/senha
